...
# Create an instance of Major
# major_instance = Major.CS
...
class Faculty:
    ...
    def __repr__(self) -> str: #,__repr__ method in action, you can create an instance of the FacultyMember class and then print it or simply type the instance name in an interactive Python session 
...
class Signup:
    ...
    def __init__(self,sign_id:int, faculty_id, username:str,password:str):
...
class Login:
    ...
    def __init__(self, user_id, username:str, password:str, faculty_id:int):

        self.user_id:int=user_id
        self.username:str=username
        self.password:str=password
        self.faculty_id:str=faculty_id
...
# faculty_member_instance = Faculty(
#     faculty_id=1,
#     fname='John',
#     lname='Doe',
#     mname='A',
...
# # Print the instance to see the result of __repr__
# print(faculty_member_instance)

# # Alternatively, simply evaluate the instance in an interactive session
# faculty_member_instance
